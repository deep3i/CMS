...
import { getUsersActivities, getUsersStatistics, getUsersActivityTypes, logoutAnyUser, deleteUsersActivity, deactivateUser, fetchAllAdmins, updateAdminAccess } from "../../service/dashboard";
...
export const getUsersActivitiesAsync = createAsyncThunk(
  ...
  async (params, { rejectWithValue, fulfillWithValue, getState }) => {
    try {
      ...
      if (response.data) {
        const { activities, pagination: { totalPages, totalItems } } = response.data;
