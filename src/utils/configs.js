export const ConfigCloudnary = {
  ...
  envVariable:
    "CLOUDINARY_URL=cloudinary://344972316838632:W3EbS2M2MtEUtH7Dng6PEtDYlRk@dx12uvyye",
};
...
export const getFlagURl = (countryCode) => `https://flagsapi.com/${countryCode.toUpperCase()}/shiny/64.png`;