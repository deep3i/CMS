...
const BlogPostComponent = () => {
  ...
  const handleCreateComment = (values) => {
    dispatch(createCommentAsync({ data: { blog_id: id, author_id: user?.id, status: 'delivered', content: values?.message }, callback: handleCallback }));
  };
        ...
        {post && (
          ...
          >
            <div>
              ...
              />
              {!commentLoading && <AdvancedCommentComponent
                comments={comments}
                user={user}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-500">
                    Published in {post.categories.join(", ")}
                  </p>
                </div>
              </div>
            </div>
